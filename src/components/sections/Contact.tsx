  ...
  const renderSocialIcon = (name: string) => {
    switch (name) {
      ...
      case 'LinkedIn':
        return (
            <a
              href="https://linkedin.com/in/iamtayyab007"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
            >
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[
                  { name: 'GitHub', href: 'https://github.com/iamtayyab007' },
                  { name: 'LinkedIn', href: 'https://linkedin.com/in/iamtayyab007' },
                  { name: 'Twitter', href: 'https://x.com/iamtayyab007' },
                ].map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-blue-900 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  >
